...
export default function FareHero() {
  return (
    <section className="relative overflow-hidden bg-amber-950">
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-18 sm:px-12 lg:px-8 lg:py-18">
        <div className="grid items-center gap-14 lg:grid-cols-[minmax(0,1fr)_400px]">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-300">
              Check taxi fares for one-way, round-trip and local journeys.
              Choose from comfortable sedans, SUVs and other vehicles with
          ...
          <div className="w-full lg:justify-self-end">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <Link
                ...
                className="group inline-flex items-center gap-2 rounded-full bg-amber-500 px-7 py-3.5 font-bold text-white shadow-lg shadow-amber-500/20 transition hover:bg-amber-600 hover:shadow-amber-500/30"
              >
                Book Your Cab
