...
const fareFactors = [
  ...
  },
  {
    title: "Distance",
    description:
      "The total journey distance between your pickup point and destination can affect the applicable fare.",
    icon: Route,
  },
  {
    title: "Travel Time",
  ...
  },
  {
    ...
    description:
      "Your group size can determine which vehicle is suitable for your journey and which fare applies.",
    icon: Users,
  },
  {
    title: "Trip Type",
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mb-12 max-w-3xl text-center">
          ...
          <p className="mt-4 leading-7 text-gray-600">
            Your taxi fare can depend on several factors, including the
            vehicle you select, journey distance, trip type and applicable
            charges.
          </p>
        </div>
