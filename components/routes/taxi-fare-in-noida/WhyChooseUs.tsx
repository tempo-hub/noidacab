...
const benefits = [
  {
    ...
    description:
      "Know the applicable fare before confirming your taxi booking with clear and straightforward pricing.",
    icon: IndianRupee,
  },
  {
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mb-12 max-w-3xl text-center">
          ...
          <h2 className="mt-5 text-3xl font-bold text-gray-900 sm:text-4xl">
            Why Choose NoidaCab for Your Taxi?
          </h2>

          <p className="mt-4 leading-7 text-gray-600">
            From choosing the right vehicle to understanding your fare, we
            make booking a taxi simple, convenient and comfortable.
          </p>
        </div>
        ...
        {/* Bottom CTA */}
        <div className="mt-12 rounded-3xl bg-amber-400 px-7 py-10 text-center sm:px-10">
          <h3 className="text-2xl font-bold text-gray-900 sm:text-3xl">
            Ready to Book Your Taxi?
          </h3>

          <p className="mx-auto mt-3 max-w-2xl leading-7 text-gray-900">
