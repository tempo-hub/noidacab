...
export default function TravelGuideSection({
  ...
  const travelFacts = [
    ...
    },
    {
      ...
      description:
        "Journey time can vary depending on traffic, pickup location, road conditions and stops.",
    },
    {
      icon: Route,
      title: "Route",
      ...
      description:
        "Your Tempo Traveller driver can select a suitable route based on your pickup and drop-off locations.",
    },
    {
      icon: TrafficCone,
      title: "Traffic",
      ...
      description:
        "Peak-hour traffic can increase travel time, especially during busy commuting periods.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="max-w-4xl">
          ...
          <p className="mt-3 text-base leading-7 text-slate-600">
            ...
            {route.from.name} to{" "}
            {route.to.name} with a Tempo Traveller.
            The total distance and travel time can vary
            depending on your exact pickup location,
            destination, traffic conditions and stops
            requested during the journey.
          </p>
        ...
        <div className="mt-7 grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600">
              ...
              flight, train or event to attend, allow
              additional time for traffic and possible
              stops. You can select your pickup date and
              time while booking your Tempo Traveller.
            </p>
            ...
            >
              Check {routeName} Tempo Traveller Fare →
            </Link>
