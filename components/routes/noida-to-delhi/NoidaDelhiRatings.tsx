...
const servicePoints = [
  {
    ...
    description:
      "Drivers arrive on schedule so your Noida to Delhi journey starts without unnecessary waiting.",
  },
  {
    icon: ShieldCheck,
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            What Travellers Say About Noida to New Delhi Cabs on NoidaCabs  
          </h2>
            ...
            <div className="relative overflow-hidden bg-slate-900 p-7 text-white sm:p-8">
              ...
              <div className="relative">
                ...
                <p className="mt-5 text-sm leading-6 text-slate-400">
                  Consistently rated for dependable service, comfortable
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-amber-100 text-amber-700">
                  <ThumbsUp size={19} fill="currentColor" />
                </div>
                ...
                <div>
                  ...
                  <p className="mt-1 max-w-2xl text-sm leading-6 text-slate-600">
                    Whether you&apos;re heading to Delhi for work, the airport,
                    or a day out, our focus is on making your journey
                    comfortable from pickup to drop-off.
                  </p>
                </div>
              </div>
