...
const specialLocations = [
  {
    ...
    description:
      "Book an airport taxi with a convenient pickup from your selected location. Share your travel details while booking so the pickup can be planned around your journey.",
    icon: Plane,
  },
  {
    title: "Railway Station Transfers",
    description:
      "You can also book a cab for railway station pickup or drop. Select your exact pickup and destination while making your booking.",
    icon: TrainFront,
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-base leading-7 text-slate-600">
            You can book a{" "}
            {route.from.name} to{" "}
            {route.to.name} taxi from many
            residential, commercial and business
            areas across {route.from.name}. Select
            your exact pickup location while making
            your booking.
          </p>
        </div>
        ...
        <p className="mt-7 text-sm leading-6 text-slate-600">
          Pickup availability and travel time may
          vary depending on your exact location,
          traffic and destination in{" "}
          {route.to.name}. Enter your pickup and
          drop locations in the booking form to check
          the available cab options.
        </p>
      </div>
    </section>
  );
