...
export default function HeroSection({
  ...
  const handleTabChange = (
    ...
    if (type === "airport") {
      setFrom(route.from.name);
      setTo(`${route.to.name} Airport`);
    }
    ...
    <section className="relative overflow-hidden bg-gradient-to-r from-amber-600 via-amber-500 to-amber-400 py-12">
      ...
      <div className="relative mx-auto max-w-[1800px] px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mb-5 flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          {/* Service Tabs */}
          <div className="grid w-full grid-cols-4 gap-1 rounded-full bg-gray-100 p-1 lg:w-auto">
            {bookingTabs.map((tab) => {
              const active =
                bookingType === tab.id;
        ...
        <div className="overflow-hidden rounded-lg bg-white shadow-xl">
          <div className="grid lg:grid-cols-[1.2fr_1.2fr_1fr_1fr_255px]">
            ...
            <button
              ...
              className="flex min-h-[110px] items-center justify-center gap-2 bg-orange-500 px-6 text-xl font-bold text-white transition hover:bg-orange-600"
            >
              <Search size={22} />
              SEARCH
            </button>
