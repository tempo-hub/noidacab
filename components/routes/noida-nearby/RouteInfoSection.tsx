      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="max-w-4xl">
          ...
          <p className="mt-3 text-base leading-7 text-slate-600">
            Your driver can choose a suitable route
            based on your pickup location, drop point,
            current traffic and time of day.
          </p>
        </div>
        ...
        <div className="mt-6 rounded-xl border border-amber-100 bg-amber-50 p-5 sm:p-6">
          <p className="text-sm leading-6 text-slate-700 sm:text-base">
            ...
            your pickup and drop locations, traffic
            conditions and the route selected by your
            driver.
          </p>
        </div>
