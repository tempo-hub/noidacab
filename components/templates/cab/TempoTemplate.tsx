    ...
    export function TempoTemplate({ location, vehicle, url }: CabTemplateProps) {
      return (
        <>
    
          <HeroSection location={location} vehicle={vehicle} tagline="Spacious tempo, ideal for comfortable city and outstation travel" />
