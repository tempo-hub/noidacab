      ...
      <div className="grid grid-cols-1 gap-4 sm:gap-6 p-5 sm:p-8 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div>
          ...
          <input
            ...
            className="h-12 sm:h-14 w-full rounded-xl border border-gray-200 px-4 text-sm sm:text-base outline-none transition focus:border-red-600"
          />
        </div>
        ...
        <div>
          <label className="mb-2 flex items-center gap-2 text-sm font-semibold text-gray-700">
            <CarFront className="h-4 w-4 text-red-600" />
            Vehicle
          </label>

          <div className="relative">
            <select className="h-12 sm:h-14 w-full appearance-none rounded-xl border border-gray-200 px-4 pr-10 text-sm sm:text-base outline-none transition focus:border-red-600">
              <option>Sedan</option>
              <option>SUV</option>
        ...
        <div className="flex items-end sm:col-span-2 lg:col-span-1">
          <button className="h-12 sm:h-14 w-full rounded-xl bg-red-600 text-base sm:text-lg font-semibold text-white transition hover:bg-red-700">
            Search Cabs
          </button>
        </div>
      </div>
