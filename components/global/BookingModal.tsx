      ...
      <div className="bg-white rounded-2xl w-full max-w-2xl p-6 max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full h-11 px-4 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:bg-white focus:border-gray-500 focus:ring-2 focus:ring-gray-500 focus:outline-none transition-all duration-200 placeholder:text-gray-400 hover:border-gray-400"
          ...
          <div>
            ...
            <select
              name="tripType"
              className="w-full h-11 px-4 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:bg-white focus:border-gray-500 focus:ring-2 focus:ring-gray-500 focus:outline-none transition-all duration-200 hover:border-gray-400"
              onChange={handleChange}
            >
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:bg-white focus:border-gray-500 focus:ring-2 focus:ring-gray-500 focus:outline-none transition-all duration-200 placeholder:text-gray-400 hover:border-gray-400 resize-y"
              onChange={handleChange}
            />
            <p className="text-xs text-gray-500 mt-1">
        ...
        <div className="mt-6 pt-4 border-t border-gray-100">
          <div className="bg-white/95 rounded-lg p-3 mb-4 flex justify-between items-center border border-gray-200">
            <div>
