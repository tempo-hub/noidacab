    ...
    <div className="min-h-screen bg-slate-100 py-10 px-4">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-8">
        ...
        <input
          ...
          className="w-full p-3 border rounded-xl mb-4 outline-none focus:ring-2 text-slate-800"
        />
        ...
        {/* Editor */}
        <div
          className="h-[400px] text-slate-800 mb-6 border rounded-xl overflow-auto [&_ol]:list-decimal [&_ol]:pl-8 [&_ul]:list-disc [&_ul]:pl-8 [&_h1]:text-4xl [&_h1]:font-bold [&_h1]:mb-4
  ...
  [&_p]:text-base [&_p]:mb-4 [&_p]:leading-relaxed"
        ...
        <div className="flex justify-end gap-4 mt-4">
          ...
          <button
            ...
            disabled={loading}
            className="px-6 py-3 bg-amber-600 text-white rounded-xl hover:opacity-90 transition disabled:opacity-60 cursor-pointer"
          >
