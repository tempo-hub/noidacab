...
import BlogContentWithBooking from "@/components/global/BlogContentWithBooking";
...
export async function generateMetadata({
  ...
  if (!blog) {
    return {
      title: "Blog Not Found | Noida Cab",
    };
  }
...
export default async function BlogDetailPage({
  ...
  return (
    <div className="bg-white/95 min-h-screen py-10 px-4">
      <div className="max-w-5xl mx-auto bg-white/90 text-slate-800 rounded-2xl shadow-lg overflow-hidden">
        {/* Blog Image */}
        {blog.imageId && (
